...
export default {
    state: {
        ...
        getshou:[],
        sildeShow:false,
        baseUrl:'https://bird.ioliu.cn/v1?url=https://mobilecdn.kugou.com',
        baseUrlsetRecord:'https://bird.ioliu.cn/v1?url=https://www.kugou.com',
        baseUrlMusic:'https://bird.ioliu.cn/v1?url=https://m.kugou.com'
    },
    getters: {
        getRange(state) {
